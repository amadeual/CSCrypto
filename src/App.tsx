        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mt-16 text-center">
            ...
            <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
              {/* Contact Information */}
              <div className="bg-gray-900/70 backdrop-blur-lg border border-gray-700/50 rounded-2xl p-8">
                ...
                <p className="text-gray-300 mb-6">
                  Get help with your transactions, technical issues, or general questions
                </p>
                <a 
                  href="mailto:support@coinswap.cfd"
                  className="inline-flex items-center space-x-2 bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 text-white px-6 py-3 rounded-lg font-medium transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-blue-500/25"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                    <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                  </svg>
                  <span>support@coinswap.cfd</span>
                </a>
              </div>
              ...
              <div className="bg-gray-900/70 backdrop-blur-lg border border-gray-700/50 rounded-2xl p-8">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-gray-800/50 rounded-lg">
                    ...
                    <span className="text-white font-semibold">8:00 AM - 6:30 PM UTC</span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-gray-800/50 rounded-lg">
