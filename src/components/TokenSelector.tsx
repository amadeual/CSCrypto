...
export function TokenSelector({ selectedToken, onSelectToken, excludeToken, label, isOpen, onToggle }: TokenSelectorProps) {
  ...
  return (
    <div className="relative token-selector-container">
      ...
      {/* Token Dropdown */}
      {isOpen && (
        <div className="absolute top-full left-0 right-0 mt-2 bg-gray-800/95 backdrop-blur-lg border border-gray-700/50 rounded-xl shadow-2xl z-[9999] max-h-80 overflow-hidden">
          {/* Search */}
